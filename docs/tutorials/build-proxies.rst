...
(`see how to draw one <https://docs.extendedmatrix.org/en/1.5.0/draw_the_matrix.html>`_),
...
* A ``.graphml`` file produced in yEd —
  `see how to draw the matrix <https://docs.extendedmatrix.org/en/1.5.0/draw_the_matrix.html>`_.
...
* `Draw the Extended Matrix <https://docs.extendedmatrix.org/en/1.5.0/draw_the_matrix.html>`_
