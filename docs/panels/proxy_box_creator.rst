...
.. seealso::
   ...
   - :doc:`em-doc:paradata_group` — DP-60 formal definition of the
     ``<US>_PD`` group (Paradata NodeGroup) written by this panel.
...
wrapped in a per-US ParadataNodeGroup (``<US>_PD``) — see
:doc:`em-doc:paradata_group` for the DP-60 formal definition.
