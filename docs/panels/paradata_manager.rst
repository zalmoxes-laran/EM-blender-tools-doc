...
.. seealso::
   ...
   - :doc:`em-doc:paradata_nodes` — formal definition of Property,
     Extractor, Combiner and Document nodes.
   - :doc:`em-doc:paradata_group` — how paradata is grouped per
     stratigraphic unit (DP-60).
